...
const { createPoolProcessing, getPoolsInProcessings, getPoolProcessingById, updatePoolProcessing,
...
router.route("/pool-processing-byPoolId/:pool_id")
     .get(getPoolProcessingByPoolId);

// get pool processings by symbol
router.route("/pool-processings-bySymbol/:symbol")
     .get(getPoolProcessingsBySymbol);
